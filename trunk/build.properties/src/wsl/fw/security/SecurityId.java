...
public class SecurityId implements Principal, Serializable
{
    ...
    private final static String _ident = "$Date: 2002/06/11 23:11:42 $  $Revision: 1.1.1.1 $ "
        + "$Archive: /Framework/Source/wsl/fw/security/SecurityId.java $ ";
    ...
    public SecurityId(String username, String password, boolean bEncode)
    {
        ...
        // if bEncode compute a message digest of the password, convert it to
        // an ASCII String and store it, otherwise store unencoded
        if (bEncode)
            try
            {
            ...
            {
                // repackage as a suitable runtime exeption
    ...
    public boolean equals(Object other)
    {
        ...
        if (other instanceof SecurityId)
        {
            ...
            if (_username.equals(osid._username)
                && _password.equals(osid._password))
                return true;
        }
    ...
    public int hashCode()
    {
        // calculate the hashcode from the xor of the two fields.
    ...
    public static void main(String args[])
    {
        ...
        if (args.length != 1)
        {
            ...
            //System.out.println("Generate the encrypted form of a password.");
            System.out.println(MAIN1.getText());
            //System.out.println("Syntax is java wsl.fw.security.SecurityId <password>");
