...
public class DataViewField extends DataObject implements Field
{
    ...
    public final static String ENT_DVFIELD          = "TBL_DVFIELD";
    ...
    public final static String FLD_SOURCE_ENTITY    = "FLD_SOURCE_ENTITY";
    public final static String FLD_SOURCE_FIELD     = "FLD_SOURCE_FIELD";
    public final static String FLD_DISPLAY_NAME     = "FLD_DISPLAY_NAME";
    public final static String FLD_FLAGS            = "FLD_FLAGS";
    public final static String FLD_OPTION_LIST      = "FLD_OPTION_LIST";
    ...
    public static Entity createEntity()
    {
        ...
        ent.addJoin(new JoinImpl(ENT_DVFIELD, FLD_DATAVIEWID,
            DataView.ENT_DATAVIEW, DataView.FLD_ID));
        ent.addJoin(new JoinImpl(ENT_DVFIELD, FLD_SOURCE_ENTITY,
            EntityDobj.ENT_ENTITY, EntityDobj.FLD_NAME));
        ent.addJoin(new JoinImpl(ENT_DVFIELD, FLD_SOURCE_FIELD,
            FieldDobj.ENT_FIELD, FieldDobj.FLD_NAME));
    ...
    public int getFlags()
    {
        // check explicitly for null as null normally converts to -1 which
        // is equivalent to all flags
        if (getObjectValue(FLD_FLAGS) == null)
            return 0;
        else
...
//==============================================================================
// end of file DataViewField.java
//==============================================================================
