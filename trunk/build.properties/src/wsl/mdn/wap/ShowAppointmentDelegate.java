...
import wsl.fw.msgserver.AppointmentDobj;
...
public class ShowAppointmentDelegate extends MdnWmlServletDelegate
{
    //--------------------------------------------------------------------------
    // construction
     ...
     * Default ctor
     */
    public ShowAppointmentDelegate()
    {
    }
    ...
    public void run() throws ServletException, IOException
    {
        try
        {
            ...
            if(strIndex != null && strIndex.length() > 0)
            {
                ...
                AppointmentDobj a = (AppointmentDobj)pcd.getMessage(index);
                Util.argCheckNull(a);

                // subject as title
                card.setTitle(WEUtil.esc(a.getFieldValue(AppointmentDobj.FLD_SUBJECT)));
