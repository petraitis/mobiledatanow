/**	$Id: MdnWmlServletDelegate.java,v 1.2 2002/06/25 03:58:57 jonc Exp $
 *
...
public abstract class MdnWmlServletDelegate
	extends ServletDelegate
{
	 ...
	 */
	protected MdnWmlServlet getServlet()
	{
		return (MdnWmlServlet) _servlet;
	}
		...
		throws ServletException, IOException
	{
		...
		_request.setAttribute (
			MdnWmlServlet.RP_ACTION,
			MdnWmlServlet.ACT_NEXTPVPAGE);
