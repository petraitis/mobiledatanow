...
public class FieldPropPanel extends PropertiesPanel implements ActionListener
{
    ...
    public final static HelpId HID_FIELD = new HelpId("mdn.admin.FieldPropPanel");
    ...
    public void transferData(boolean toDataObject)
    {
        ...
        if (toDataObject)
        {
            ...
            String strType = (String)_cmbType.getSelectedItem();
            if(strType.equalsIgnoreCase(FT_STRING.getText()))
                type = Field.FT_STRING;
            else if(strType.equalsIgnoreCase(FT_INTEGER.getText()))
                type = Field.FT_INTEGER;
            else if(strType.equalsIgnoreCase(FT_DECIMAL.getText()))
                type = Field.FT_DECIMAL;
            else if(strType.equalsIgnoreCase(FT_DATETIME.getText()))
                type = Field.FT_DATETIME;
            else if(strType.equalsIgnoreCase(FT_CURRENCY.getText()))
                type = Field.FT_CURRENCY;
            dobj.setType(type);
            ...
            if(_chkUniqueKey.isSelected())
                flags = flags | Field.FF_UNIQUE_KEY;
            if(_chkReadOnly.isSelected())
                flags = flags | Field.FF_READ_ONLY;
            dobj.setFlags(flags);
        }
        else
        {
            ...
            switch(type)
            {
                case Field.FT_STRING: strType = FT_STRING.getText(); break;
                case Field.FT_INTEGER: strType = FT_INTEGER.getText(); break;
                case Field.FT_DECIMAL: strType = FT_DECIMAL.getText(); break;
                case Field.FT_DATETIME: strType = FT_DATETIME.getText(); break;
                case Field.FT_CURRENCY: strType = FT_CURRENCY.getText(); break;
            }
