...
import wsl.fw.msgserver.Task;
import ie.omk.smpp.Connection;

public class SMPPAPIExample  extends Task {
    
    public SMPPAPIExample(String subject, String text, String type, String isComplete, String status, String startDate, String dueDate, String priority) {
		super(subject, text, type, isComplete, status, startDate, dueDate, priority);
		// TODO Auto-generated constructor stub
	}
	public SMPPAPIExample() {
		super("", "", "", "", "", "", "", "");
		//super();
		// TODO Auto-generated constructor stub
	}
