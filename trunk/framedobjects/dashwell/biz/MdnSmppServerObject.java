...
public class MdnSmppServerObject {
	...
	public MdnSmppServerObject(int id, String number, String host, String port, String username, String password, String sourceNpi, 
			String sourceTon, String destNpi, String destTon, String bindNpi, String bindTon, String type, int useTlv, int interval,
			Connection smppConnection, int useAddrRange){
		this.id = id;
		this.number = number;
		this.host = host;
		this.port = port;	
