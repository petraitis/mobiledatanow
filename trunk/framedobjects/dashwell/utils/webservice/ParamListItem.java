 ...
 * request or response. In fact, it is a data protocol between the {@link ParamHelper} and the
 ...
 * 
 */
public class ParamListItem implements Serializable {
   ...
   * @param isArray true, if it an array.
   */
  public ParamListItem(String datatype,boolean isPrimitive,String label,Object defaultValue,boolean isArray)  {
    m_VectorData=new Vector();
   ...
   * stored in the {@link ParamListItem} object.
   * 
