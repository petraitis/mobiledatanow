 ...
 * 
 */
public class WSshort extends ParamView {
  
  private static final Logger LOGGER = Logger.getLogger(WSshort.class);
   ...
   */
  public WSshort(ParamListItem paramListItem) throws MdnException {
   ...
   */
  public WSshort(ParamListItem paramListItem,int arrayIndex) throws MdnException {
