...
public class DataUtils {
  ...
  public synchronized static Vector getLanguages(){
  ...
  public synchronized static String getLocale(String language){
    String locale = "en_UK";    // Have a default.
  ...
  public synchronized static String getLanguage(String locale){
    String language = LANGUAGE_ENGLISH;    // Have a default.
  ...
  public synchronized static String getMetaFieldType(String origFieldType){
    ...
    if (origFieldType != null){
      ...
      if (checkString.indexOf("CHAR") >= 0){
        metaFieldType = MetaField.TYPE_STRING;
          ...
          metaFieldType = MetaField.TYPE_INTEGER;
      } else if (checkString.indexOf("NUMBER") >= 0){    // Excel.
            metaFieldType = MetaField.TYPE_INTEGER;
  ...
  public synchronized static Vector getQueryValues(){
  ...
  public synchronized static Vector getQuerySortOrders(){
    Vector<String> values = new Vector<String>();
  ...
  public synchronized static int getFieldTypeInt(String metaFieldType){
  ...
  public synchronized static int getFieldTypeIntOrig(String origFieldType){
    return getFieldTypeInt(getMetaFieldType(origFieldType));
  }
  
  public synchronized static String getFieldType(int fieldTypeInt){
  ...
  public synchronized static Vector getMetaFieldTypes(){
  ...
  public synchronized static Vector getOperators(){
