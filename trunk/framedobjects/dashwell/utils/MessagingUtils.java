...
/**
 * Utility class for MDN Messaging Services.
 * 
 * @author Adele
 */
...
public class MessagingUtils {
	  ...
	  public static int getConnectionIdByName(String connectionName){
		...
		public static String responseMassageParser2(String responseFormat, List premissionFieldsName, DataObject obj, Vector allFields){
			List indexList = new ArrayList();
