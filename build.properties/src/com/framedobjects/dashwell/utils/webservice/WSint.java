 ...
 * 
 */
public class WSint extends ParamView {
  
  private static final Logger LOGGER = Logger.getLogger(WSint.class);
   ...
   */
  public WSint(ParamListItem paramListItem) throws MdnException {
   ...
   */
  public WSint(ParamListItem paramListItem,int arrayIndex) throws MdnException {
