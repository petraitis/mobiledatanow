 ...
 * 
 */
public class WSlong extends ParamView {
  
  private static final Logger LOGGER = Logger.getLogger(WSlong.class);
   ...
   */
  public WSlong(ParamListItem paramListItem) throws MdnException {
   ...
   */
  public WSlong(ParamListItem paramListItem,int arrayIndex) throws MdnException {
