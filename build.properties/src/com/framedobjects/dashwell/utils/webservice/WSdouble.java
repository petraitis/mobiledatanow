 ...
 * 
 */
public class WSdouble extends ParamView {
  
  private static final Logger LOGGER = Logger.getLogger(WSdouble.class);
   ...
   */
  public WSdouble(ParamListItem paramListItem) throws MdnException {
   ...
   */
  public WSdouble(ParamListItem paramListItem,int arrayIndex) throws MdnException {
