...
// $Archive: /Framework/Source/wsl/fw/notification/Notifier.java $
//==============================================================================
...
public interface Notifier extends RmiServant
{
    ...
    public final static String NT_ALL = "wsl.fw.notification.type._all_";

    // standard notification subtypes
    /** Receive all notifications irrespective of subtype, use only for
     * listening, not sending */
    public final static String NST_ALL = "wsl.fw.notification.subtype._all_";
    /** Used to send or recieve notifications that do not have a subtype */
    public final static String NST_NONE = "wsl.fw.notification.subtype._none_";
