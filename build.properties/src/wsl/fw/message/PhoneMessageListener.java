...
public class PhoneMessageListener extends MessageListenerBase
{
    ...
    private final static String _ident = "$Date: 2002/06/11 23:11:42 $  $Revision: 1.1.1.1 $ "
        + "$Archive: /Framework/Source/wsl/fw/message/PhoneMessageListener.java $ ";
    ...
    public PhoneMessageListener(String args[])
    {
        ...
        Vector v = new Vector();
        if (_mtHomePhone != null)
            v.add(_mtHomePhone);
        if (_mtMobilePhone != null)
            v.add(_mtMobilePhone);
    ...
    protected int onMessage(String msgType, Message msg)
    {
        ...
        if ((_mtMobilePhone != null && _mtMobilePhone.equals(msgType))
            || (_mtHomePhone != null && _mtHomePhone.equals(msgType)))
            rv = processPhone(msg);
        else
...
//==============================================================================
// end of file PhoneMessageListener.java
//==============================================================================
