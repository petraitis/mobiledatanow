...
{
    // version tag
    private final static String _ident = "$Date: 2003/02/10 20:45:43 $  $Revision: 1.2 $ "
        + "$Archive: /Mobile Data Now/Source/wsl/mdn/guiconfig/LoginSettings.java $ ";

    // the entity name
    public final static String ENT_LOGINSETTINGS = "ENT_LOGINSETTINGS";

    // field names
    public final static String FLD_ID             = "FLD_ID";
    public final static String FLD_FLAGS          = "FLD_FLAGS";
    public final static String FLD_SPLASHTITLE    = "FLD_SPLASHTITLE";
    public final static String FLD_SPLASHTEXT     = "FLD_SPLASHTEXT";
    public final static String FLD_LOGINTITLE     = "FLD_LOGINTITLE";
    public final static String FLD_LOGINTEXT      = "FLD_LOGINTEXT";
    public final static String FLD_USERNAMEPROMPT = "FLD_USERNAMEPROMPT";
    public final static String FLD_PASSWORDPROMPT = "FLD_PASSWORDPROMPT";
    public final static String FLD_LOGOUTTITLE    = "FLD_LOGOUTTITLE";
    public final static String FLD_LOGOUTTEXT     = "FLD_LOGOUTTEXT";

    // flag constants
    public final static int FLAG_USE_SPLASHSCREEN = 1;
    public final static int FLAG_REQUIRE_PASSWORD = 2;
    public final static int FLAG_NUMERIC_PASSWORD = 4;
    ...
    {
        // create a default one in case we cannot get from db
        LoginSettings loginSettings = new LoginSettings();

        // query DB and get the one record
        ...
        try
        {
            ...
            if (rs.next())
                loginSettings = (LoginSettings) rs.getCurrentObject();

            // else insert the default
            else
            {
...
//==============================================================================
// end of file LoginSettings.java
//==============================================================================
